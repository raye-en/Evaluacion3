...
<body>
	<div class="container">
		<form:form method="post" action="/ventas/update/${ventas.id}" modelAttribute="ventas">
			...
			<br>
			<a href="/ventas" class="btn btn-success" role="button" data-bs-toggle="button">Volver</a>
